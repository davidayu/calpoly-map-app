...
function Legend(props) {
    ...
    function toggleExpand(){
        var legend = document.getElementById("legend-attributes");
  ...
  return (
      <div>
        <button type="button" class="button" id="expand" name="expand" onClick={handleChange}>
            <ExpandIcon onClick={handleChange}/>
        </button>
        <div id="legend-attributes">
        <fieldset>
            <legend>Legend</legend>
            <div class="study-spaces">
                <label> <StudyIcon /> Study Spaces
                <input
                    type="checkbox"
                    id="study"
                    name="study"
            ...
            <div class="eating-spaces">
                <label> <EatingIcon /> Eating Spaces 
                <input
                    type="checkbox"
                    id="eating"
                    name="eating"
            ...
            <div class="relaxing-spaces">
                <label> <RelaxingIcon /> Relaxing Spaces 
                <input
                    type="checkbox"
                    id="relaxing"
                    name="relaxing"
